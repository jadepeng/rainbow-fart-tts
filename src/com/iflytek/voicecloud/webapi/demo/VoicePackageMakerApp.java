...
public class VoicePackageMakerApp {
    ...
    static AtomicInteger finishCount = new AtomicInteger();
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Contribute contribute : manifest.getContributes()) {
            ...
            for (String text : contribute.getText()) {
                ...
                tts2mp3(text, Paths.get(packageName, fileName).toString(), vcnName);
            }
        }
    ...
    static void tts2mp3(String text, String mp3Path, String vcn) throws Exception {
        // 构建鉴权url
